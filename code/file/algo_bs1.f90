...
!!\n                              3 = both
  ...
  call force (time,jcen,nbod,nbig,mass,x0,v0,s,rcrit,a0,stat,ngf,ngflag,nce,ice,jce,rphys)
  ...
  do
     ...
     do n = 1, 8
        ...
        call force (time,jcen,nbod,nbig,mass,x,v,s,rcrit,a,stat,ngf,ngflag,nce,ice,jce,rphys)
        do k = 2, nbod
        ...
        do j = 2, n
           call force (time,jcen,nbod,nbig,mass,xend,vend,s,rcrit,a,stat,ngf,ngflag,nce,ice,jce,rphys)
           do k = 2, nbod
