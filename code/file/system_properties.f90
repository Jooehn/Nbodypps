...
!
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
subroutine mce_init (h,jcen,rcen,cefac,nbod,nbig,m,x,v,s,rho,rceh,rphys,rce,rcrit,id,outfile,rcritflag,m_x)
...
!do not write m_x in ce.out
     c(j)(52:59) = mio_fl2c (m_x(j) * k_2)
  ...
  ! Write compressed output to file : ce.out
